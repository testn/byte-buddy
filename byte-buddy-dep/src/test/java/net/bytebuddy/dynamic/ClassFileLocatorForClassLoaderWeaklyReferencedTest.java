...
public class ClassFileLocatorForClassLoaderWeaklyReferencedTest {
    ...
    public void testCreation() throws Exception {
        assertThat(ClassFileLocator.ForClassLoader.WeaklyReferenced.of(classLoader), instanceOf(ClassFileLocator.ForClassLoader.WeaklyReferenced.class));
    }
    ...
    public void testSystemClassLoader() throws Exception {
        assertThat(ClassFileLocator.ForClassLoader.WeaklyReferenced.of(ClassLoader.getSystemClassLoader()), instanceOf(ClassFileLocator.ForClassLoader.class));
    }

    @Test
    public void testPlatformClassLoader() throws Exception {
        assertThat(ClassFileLocator.ForClassLoader.WeaklyReferenced.of(ClassLoader.getSystemClassLoader().getParent()), instanceOf(ClassFileLocator.ForClassLoader.class));
    }

    @Test
    public void testBootLoader() throws Exception {
        assertThat(ClassFileLocator.ForClassLoader.WeaklyReferenced.of(null), instanceOf(ClassFileLocator.ForClassLoader.class));
    }
