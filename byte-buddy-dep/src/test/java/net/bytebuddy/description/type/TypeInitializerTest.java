...
public class TypeInitializerTest {
    ...
    public void testNoneExpansion() throws Exception {
        assertThat(TypeInitializer.None.INSTANCE.expandWith(byteCodeAppender), instanceOf(TypeInitializer.Simple.class));
    }
    ...
    public void testSimpleExpansion() throws Exception {
        assertThat(new TypeInitializer.Simple(byteCodeAppender).expandWith(byteCodeAppender), not(byteCodeAppender));
    }
